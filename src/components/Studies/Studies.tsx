        ...
        >
            ...
            <div className="flex flex-col md:flex-row w-full max-w-7xl items-center justify-between gap-10 md:gap-14">
                ...
                <div className="w-full md:w-1/2 space-y-8">
                    ...
                    >
                        <h2 className="text-2xl md:text-3xl font-bold mb-3">Professional Master's in Applied Computer Methods for Business Management</h2>
                        <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400">Faculty of Science and Technology, Settat</p>
                        <p className="text-md md:text-lg text-gray-500 dark:text-gray-300 font-semibold">2022 - 2024</p>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        className="bg-gray-100 dark:bg-gray-800 p-6 md:p-8 rounded-xl shadow-xl hover:shadow-red-500 transition-all duration-300"
                    >
                        <h2 className="text-2xl md:text-3xl font-bold mb-3">Professional Bachelor's in Computerized Management of Organizations</h2>
                        <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400">Faculty of Legal, Economic, and Social Sciences, Meknes</p>
                        <p className="text-md md:text-lg text-gray-500 dark:text-gray-300 font-semibold">2021 - 2022</p>
                    </motion.div>
                </div>
