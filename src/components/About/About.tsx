...
const About: React.FC = () => {
    ...
    return (
        <>
            ...
            <Helmet>
                <title>{t("about.title")} - Rabie Lafkir</title>
            </Helmet>
            <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                    ...
                    <div className="flex items-center flex-col py-10 w-full">
                        ...
                        >
                            ...
                            <h2 className="text-gray-600 dark:text-gray-400 md:text-2xl max-w-2xl mx-auto"
                                dangerouslySetInnerHTML={{ __html: t("about.fullstack") }}>
                            </h2>
                        </motion.div>
                    </div>
                </header>
                ...
                >
                    <div className="flex flex-wrap -mx-2">
                        <div className="sm:w-3/4 px-2">
                            <h3 className="mb-4 text-xl font-semibold">{t("about.title")}</h3>
                        ...
                        >
                            <h3 className="mb-4 text-xl font-semibold">{t("about.contact")}</h3>
                            <div className="space-y-4">
                                <a href="mailto:lafkirrabie2000@gmail.com" className="flex items-center text-gray-700 dark:text-white hover:text-red-500 dark:hover:text-red-500">
                                    ...
                                    <span className="ml-2">{t("about.email")}</span>
                                </a>
                                <a href="https://github.com/Rabie-Lafkir" target="_blank" className="flex items-center text-gray-700 dark:text-white hover:text-red-500 dark:hover:text-red-500">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill={"none"}>
                                    ...
                                    <span className="ml-2">{t("about.github")}</span>
                                </a>
                                <a href="https://www.linkedin.com/in/rabie-lafkir/" target="_blank" className="flex items-center text-gray-700 dark:text-white hover:text-red-500 dark:hover:text-red-500">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill={"none"}>
                                    ...
                                    <span className="ml-2">{t("about.linkedin")}</span>
                                </a>
                            </div>
                        </motion.div>
                    </div>
